...
let drawGameOver = () => {
    ...
    canvasContext.fillText("Game Over!", 5, 200);
...
let drawRemainingLives = () => {
    ...
    canvasContext.fillStyle = "white";
    canvasContext.fillText("Lives: ", 240, oneBlockSize * (map.length + 1));
...
checkGameOver = () => {
    if (lives <= 0) {
      createRect(0, 0, canvas.width, canvas.height, "rgba(0, 0, 0, 0.5)");
